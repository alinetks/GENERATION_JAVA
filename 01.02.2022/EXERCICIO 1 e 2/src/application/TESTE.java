...
public class TESTE {
	...
	public static void main(String[] args) 
	{
		...
		System.out.println("O cachorro se chama "+pocoto.getNome()+", ele tem "+pocoto.getIdade()+
		...
		System.out.println("O cachorro se chama "+soninho.getNome()+", ele tem "+soninho.getIdade()+
